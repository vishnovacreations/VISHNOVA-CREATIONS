...
const About: React.FC = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      description: 'Formed a strategic partnership with P Tech Consulting, combining our digital marketing expertise with their 5+ years of IT consulting and security solutions experience.'
    },
    {
      year: '2025',
      title: 'Future Vision',
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="space-y-4 mb-6">
                  <p className="text-gray-700 leading-relaxed">
                    We are proud to collaborate with <strong className="text-gray-900">P Tech Consulting</strong>, a leading IT consulting firm with over <strong>5+ years of experience</strong> in providing robust security solutions and expert IT consulting services. Based in Edmonton, Alberta, P Tech Consulting specializes in transforming businesses with cutting-edge technology solutions.
                  </p>
                  <p className="text-gray-600 leading-relaxed text-sm">
